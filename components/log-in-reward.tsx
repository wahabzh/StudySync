...
export default function CongratsDialog({ open, setOpen, userId }: CongratsDialogProps) {
    ...
    <Dialog open={showDialog || open} onOpenChange={setOpen}>
      <DialogContent className="mt-4">
        ...
        <p className="text-lg text-center mt-2">
          You have received <strong>10 points</strong> for your first login.
        </p>
        <Star className="h-24 w-24 text-yellow-500 mt-4" />
      </DialogContent>
    </Dialog>
  );
}
